...
<template>
  <div
    ...
    ref="square"
  >
    <div v-if="inventoryItem.count" class="tooltip" ref="tooltip">{{ inventoryItem.tooltip }}</div>
    <button v-else class="button" ref="button">Добавить цвет</button>
    <div class="item">
      <div class="color" v-bind:style="color"></div>
      <div class="blur" v-bind:style="blur"></div>
    </div>
